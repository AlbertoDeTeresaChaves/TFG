...
@Component({
  selector: 'app-numeros-naturales-stepper',
  standalone: true,
  imports: [MatStepperModule, MatRadioModule, RouterLink, MatIconModule, FormsModule,MatProgressSpinnerModule],
  templateUrl: './numeros-naturales-stepper.component.html',
  styleUrl: './numeros-naturales-stepper.component.scss',
  providers: [
    {
...
export class NumerosNaturalesStepperComponent {
  respuestasUsuario: string[] = new Array(5).fill('');
  respuestasCorrectas: string[] = ['resp_3', 'resp_2', 'resp_1', 'resp_1', 'resp_3'];
