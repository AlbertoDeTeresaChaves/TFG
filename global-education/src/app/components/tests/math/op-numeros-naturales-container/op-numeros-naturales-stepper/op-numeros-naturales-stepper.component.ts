...
@Component({
  selector: 'app-op-numeros-naturales-stepper',
  standalone: true,
  imports: [MatStepperModule, MatRadioModule, RouterLink, MatIconModule, FormsModule,MatProgressSpinnerModule],
  templateUrl: './op-numeros-naturales-stepper.component.html',
  styleUrl: './op-numeros-naturales-stepper.component.scss',
  providers: [
    {
...
export class OpNumerosNaturalesStepperComponent {
  respuestasUsuario: string[] = new Array(5).fill('');
  respuestasCorrectas:string[]= ['resp_1','resp_1','resp_1','resp_2','resp_1',]
